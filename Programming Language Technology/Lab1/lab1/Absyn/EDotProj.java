...
public class EDotProj extends Exp {
  public final Exp exp_1, exp_2;
  public EDotProj(Exp p1, Exp p2) { exp_1 = p1; exp_2 = p2; }

  public <R,A> R accept(lab1.Absyn.Exp.Visitor<R,A> v, A arg) { return v.visit(this, arg); }

  public boolean equals(Object o) {
    if (this == o) return true;
    if (o instanceof lab1.Absyn.EDotProj) {
      lab1.Absyn.EDotProj x = (lab1.Absyn.EDotProj)o;
